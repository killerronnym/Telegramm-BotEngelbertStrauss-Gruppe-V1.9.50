...
def get_config_from_db(bot_name):
    ...
    try:
        ...
        log_print(f"Error reading DB: {e}")
    return {}
...
async def main():
    ...
    # Alle Hosts scannen
    tasks = [asyncio.create_task(watch_one_host(h, config["TARGETS"], alert_state, sem)) for h in config["WATCH_HOSTS"]]
...
if __name__ == "__main__":
    ...
    except Exception as e: log_print(f"KRITISCHER FEHLER: {e}")
